...
class TestFindDescriptors(unittest.TestCase):
    ...
    def create_set_and_insert(self, set_name, dims, total):
        ...
        # descriptor_set["engine"] = "FaissFlat"
    ...
    def test_findDescInsertAndCount(self):

        # Add Set
        set_name = "features_128d_4_InsertAndCount"
        dims = 128
        total = 100
        ...
        self.assertEqual(response[0]["FindDescriptor"]["count"], total-1)
        # self.assertEqual(response[0]["FindDescriptor"]["returned"], total-1)
